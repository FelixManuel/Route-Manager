 ...
 */
public class FireAgentRouteA extends AgentRoute{
    //Attributes
    ...
    //Constructor
    public FireAgentRouteA(ArrayList<Point2D> exits, HashMap<String, Dimension> planes, int rows, int columns, CoordAgent coordinateAgent) {
    ...
    private FireAgentRouteA(ArrayList<Point2D> exits, ArrayList<CoordAgent> route, int movements,
    ...
    public int narrow() {
        ...
        return (result * 26) + getConsumedPoints();
    }
    ...
    public AgentRoute clone() {
        ...
        FireAgentRouteA newAgent = new FireAgentRouteA(this.getExits(), route, this.getMovements(),
